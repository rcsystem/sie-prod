...
$(document).ready(function () {
  tbl_request = $("#tbl_pagar_solicitudes_talento")
    .dataTable({
      processing: true,
      ajax: {
        method: "post",
        url: `${urls}finanzas/tbl_pagar_solicitudes_talento`,
        dataSrc: "data",
      },
      lengthChange: true,
      ordering: true,
...
$("#subirComprobante").submit(function (e) {
  ...
  $.ajax({
      url: `${urls}finanzas/subir_comprobante_talento`, // Ruta en CodeIgniter
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
