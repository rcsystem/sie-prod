...
$("#form_solicitud_viatico").submit(function (e) {
  ...
  Swal.fire({
    ...
    Eh leido, Acepto la <a href="${urls}public/doc/politicas/politica_de_viaticos_FGC-01_REV.pdf" target="_blank">política para el control de viáticos, pasajes y gastos a comprobar</a></label>`,
