...
$(document).ready(function () {
  tbl_inventary = $("#tabla_inventario_papeleria")
    .dataTable({
      ...
      ajax: {
        method: "post",
        url: `${urls}papeleria/inventario_total_vh`,
        dataSrc: "",
      },
      lengthChange: true,
      ordering: true,
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            ...
            <button type="button" class="btn btn-info btn-sm" title="Salida de Suministro"  onClick=Outlet(${data["id_product"]})>
            <i class="fas fa-minus"></i>
                      </button>
                      <button type="button" class="btn btn-info btn-sm" title="Ingresar Suministro"  onClick=Input(${data["id_product"]})>
                      <i class="fas fa-plus"></i>
                      </button>
                      <button type="button" class="btn btn-info btn-sm" title="Editar Suministro"  onClick=handleEdit(${data["id_product"]})>
...
function handleEdit(id_product) {
  ...
  $.ajax({
    type: "GET",
    url: `${urls}papeleria/editar_producto_vh/${id_product}`,
    async: true,
    dataType: "json",
    success: function (resp) {
      //console.log(resp);
...
$("#parametros_papeleria").submit(function (event) {
  ...
  $.ajax({
    data: data, //datos que se envian a traves de ajax
    url: `${urls}papeleria/parametros_vh`, //archivo que recibe la peticion
    type: "post", //método de envio
    processData: false, // dile a jQuery que no procese los datos
    contentType: false, // dile a jQuery que no establezca contentType
...
$("#registrar_articulo").submit(function (event) {
  ...
  $.ajax({
    data: data, //datos que se envian a traves de ajax
    url: `${urls}papeleria/entrada_vh`, //archivo que recibe la peticion
    type: "post", //método de envio
    processData: false, // dile a jQuery que no procese los datos
    contentType: false, // dile a jQuery que no establezca contentType
    success: function (response) {
...
$("#salida_articulos").submit(function (event) {
  ...
  $.ajax({
    data: data, //datos que se envian a traves de ajax
    url: `${urls}papeleria/salidas_vh`, //archivo que recibe la peticion
    type: "post", //método de envio
    processData: false, // dile a jQuery que no procese los datos
    contentType: false, // dile a jQuery que no establezca contentType
    success: function (response) {
...
$("#nuevo_articulo").submit(function (event) {
  ...
  $.ajax({
    data: data, //datos que se envian a traves de ajax
    url: `${urls}papeleria/nuevo_articulo_vh`, //archivo que recibe la peticion
    type: "post", //método de envio
    processData: false, // dile a jQuery que no procese los datos
    contentType: false, // dile a jQuery que no establezca contentType
    success: function (response) {
