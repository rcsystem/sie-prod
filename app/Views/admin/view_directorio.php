...
<div class="content-wrapper">
 ...
 <!-- Formulario para agregar directorios -->
 <div class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Agregar Nuevo Directorio</h3>
                    </div>
                    <div class="card-body">
                        <form id="directoryForm">
                            <div class="form-group">
                                <label for="directoryName">Nombre del Directorio</label>
                                <input type="text" class="form-control" id="directoryName" required>
                            </div>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-folder-plus"></i> Crear Directorio
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Directorios Creados</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered">
                            <thead>
                                <tr style="font-family: 'Roboto Condensed';">
                                    <th>#</th>
                                    <th>Nombre</th>
                                    <th>Apellido</th>
                                    <th>Extension</th>
...
<script src="<?= base_url() ?>/public/js/users/directorio_v1.js"></script>
