                        ...
                        <form id="permiso_medico" method="post">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="turno" id="turno" class="form-control" onchange="validar()">
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="tipo_permiso" id="tipo_permiso" class="form-control" onchange="validar()">
                                        <option value="">Opciones...</option>
                                        <option value="1">Salida</option>
                                        <option value="2">Incapacidad Interna</option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="motivo" id="motivo" class="form-control" onchange="validar()">
                                        <option value="">Opciones...</option>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input list="browsers" id="sistemas" name="sistemas" class="form-control" onchange="validar()">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="diagnostico" id="diagnostico" class="form-control" style="height:10rem!important;" onchange="validar()"></textarea>
                                    <div class="text-danger" id="error_diagnostico"></div>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="observaciones">Observaciones para Permiso:</label>
                                    <textarea name="observaciones" id="observaciones" class="form-control" onchange="validar()"></textarea>
...
<script src="<?= base_url() ?>/public/js/medical/medical_generate_v3-1.js"></script>
<?= $this->endSection() ?>