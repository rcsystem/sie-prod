...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <section class="content-header ">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
                            <h1 style="margin-bottom:1rem;">Tickets Tecnologías de la Información</h1>
                        </div>
                        <div class="col-md-4" style="text-align: end;">
                            <input type="hidden" id="fecha_inicio">
                            <input type="hidden" id="Fecha_fin">
                            <?php if (session()->access_tickets == 1 && session()->manager_tickets != 1) { ?>
                                <input type="hidden" id="aceeso_manager" value="<?= session()->access_tickets; ?>">
                                <input type="hidden" id="btn_vista_tickets" value="1">
                                <div class="btn-group1 btn-group-toggle" data-toggle="buttons">
                                    <label style="border:none;" class="btn btn-outline-dark btn-opcion active">
                                        <!-- <input type="radio" onclick="vista(1)" checked> <i class="fas fa-users"></i> TODOS -->
                                        <input type="radio" onclick="changeViewTikets(1)" checked> <i class="fas fa-users"></i> TODOS
                                    </label>
                                    <label style="border:none;" class="btn btn-outline-dark btn-opcion">
                                        <!-- <input type="radio" onclick="vista(2)"> <i class="fas fa-user"></i> SOLO MIOS -->
                                        <input type="radio" onclick="changeViewTikets(2)"> <i class="fas fa-user"></i> SOLO MIOS
                                    </label>
                                </div>
                            <?php } ?>
                        </div>
            ...
            <?php if (session()->manager_tickets == 1 || /* session()->access_tickets == 1 */ session()->id_user == 1063 ||session()->id_user == 1) { ?>
                <section class="content-header bg-white" id="div-filtros" style="margin-top: -1rem;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2">
                                <label for="sel-filtro-prioridad">Prioridad:</label>
                                <select class="form-control" id="sel-filtro-prioridad" onchange="CargarTickets();">
                            ...
                            <div class="col-lg-2">
                                ...
                                <select id="sel-filtro-actividad" class="form-control rounded-0 select2bs4 select2-hidden-accessible" style="width: 100%; height: calc(2.25rem + 2px);" onchange="CargarTickets();">
                                    <option value="">TODAS</option>
                            ...
                            <div class="col-lg-3">
                                ...
                                <select class="form-control " style="width: 100%; height: calc(2.25rem + 2px);" id="sel-filtro-usuario" onchange="CargarTickets();">
                            ...
                            <div class="col-lg-2">
                                ...
                                <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%; height: calc(2.25rem + 2px);" id="sel-filtro-tecnico" onchange="CargarTickets();">
                                    <option value="">TODOS</option>
    ...
    <section class="content">
        ...
        <div id="div_reporte" style="display:none;">
            ...
            <?php if (session()->manager_tickets != false /* || session()->id_user == 1063 */ || session()->id_user == 1188 ||session()->id_user == 1) { ?>
            ...
            <div class="modal-content">
                ...
                <form id="form_nuevo_ticket" method="post">
                    <div class="modal-body">
                        ...
                        <?php if (session()->id_user == 1063 || session()->id_user == 1 || session()->id_user == 1334) { ?>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4">
                                    <label style="font-family: 'Roboto Condensed';font-size:15px;">Usuario:</label>
                                    <select class="form-control" id="sel-usuario" name="sel-usuario" style="width: 100%;" onchange="limpiarError(this)">
                                        <option value="">Opciones...</option>
                                        <?php foreach ($usuarios as $key) { ?>
                                            <option value="<?= $key->id_user; ?>"><?= $key->nombre; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div id="error_sel-usuario" class="text-danger"></div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control" id="sel-tecnico" name="sel-tecnico" style="width: 100%;" onchange="limpiarError(this)"></select>
                                    <div id="error_sel-tecnico" class="text-danger"></div>
                                </div>
                                <div class="col-sm-4" style="margin-top: 10px;">
                                    <label style="font-family: 'Roboto Condensed';font-size:15px;">Prioridad:</label>
                                    <select class="form-control" id="sel-agprioridad" name="sel-agprioridad" style="width: 100%;" onchange="limpiarError(this)">
                                        <option value="">Opciones...</option>
                                        <option value="2">BAJA</option>
                                        <option value="3">MEDIA</option>
                                        <option value="4">ALTA</option>
                                    </select>
                                    <div id="error_sel-agprioridad" class="text-danger"></div>
                                </div>
                                <div class="col-sm-4" style="margin-top: 10px;">
                                    <label style="font-family: 'Roboto Condensed';font-size:15px;">Estatus:</label>
                                    <select class="form-control" id="sel-agestatus" name="sel-agestatus" style="width: 100%;" onchange="solucion(),limpiarError(this)">
                                        <option value="">Opciones...</option>
                                        <option value="1">Nuevo</option>
                                        <option value="2">En proceso</option>
                                        <option value="3">Concluido</option>
                                    </select>
                                    <div id="error_sel-agestatus" class="text-danger"></div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <ul class="nav nav-pills flex-column">
                                        <?php if (session()->access_tickets == 1) { ?>
                ...
                <form id="form_cancelar" method="post">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <textarea class="form-control" id="txt-cancel-agestatus" rows="2" maxlength="450" data-toggle="validation" data-required="true" data-message="Motivo cancelacion." required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
...
<section>
    <div class="modal fade modal-conclud" id="concluirTicketModal" tabindex="-1" role="dialog" aria-labelledby="concluirTicketModalLabel" aria-hidden="false">
                ...
                <form id="form_concluir" method="post">
                    <div class="modal-body" style="padding: 3rem 1rem 4rem 1rem;text-align:center;">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-lg-12">
                                <textarea id="solucion_swl" style="width: 100%;" rows="6" class="from-control" placeholder="Escribe la solucion" required></textarea>
                            </div>
                        </div>
                        <div class="row">
...
<script src="<?php echo base_url(); ?>/public/js/tickets/administrar-tablero_v9-1.js"></script>
<?= $this->endSection() ?>