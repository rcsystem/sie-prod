...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Solitudes de Vehiculos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <div class="card-footer">
          <a href="#">Saolicitud de Vehiculos</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Autorizacion<label id="articulo"></label></h5>
...
<script src="<?= base_url() ?>/public/js/cars/authorize_v1.js"></script>
