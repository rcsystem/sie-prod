...
<div class="content-wrapper">
    ...
    <section>
        <div class="modal fade" id="supervisor_Modal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Editar Usuario<label id="articulo"></label></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editManager" method="post">
                            <input type="hidden" id="nomina_modal" name="nomina_modal" value="">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="nombre_modal">Nombre</label>
                                    <input type="text" class="form-control" id="nombre_modal" name="nombre_modal" value="" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="apellido_p_modal">Apellido Paterno</label>
                                    <input type="text" class="form-control" id="apellido_p_modal" name="apellido_p_modal" value="" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="apellido_m_modal">Apellido Materno</label>
                                    <input type="text" class="form-control" id="apellido_m_modal" name="apellido_m_modal" value="" readonly>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <button type="submit" id="actualiza_gerente" name="actualiza_requisicion" class="btn btn-guardar">Guardar</button>
                    </div>
                    </form>
                </div>
            </div>
...
<script src="<?= base_url() ?>/public/js/users/contracts_v1.js"></script>
<?= $this->endSection() ?>