...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-9">
          <h5 class="m-0">Campaña de Limpieza</h5>
        </div><!-- /.col -->
        <div class="col-sm-3">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Campaña de Limpieza</h3>
        ...
        <div class="col-md-12">
          <div class="card-body mt-3">
            ...
            <div id="content-form" class="container-fluid mb-4">
              ...
              <input type="hidden" id="tipo_evento" name="tipo_evento" value="Acciones Verdes">
                <div class="form-row">
                ...
                <div class="col-md-10 pt-4">
                  ...
                  <fieldset>
                    <legend>Seleccione las actividades:</legend>
...
<script src="<?= base_url() ?>/public/js/qhse/hse_limpieza_v2.js"></script>
