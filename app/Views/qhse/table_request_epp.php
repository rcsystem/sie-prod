    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <div class="card-body col-md-12">
          <div class="container-fluid">
            <table id="tabla_solicitudes_epp" class="table table-bordered table-striped " role="grid" aria-describedby="invetario_epp" style="width:100%" ref="">
...
<script src="<?= base_url() ?>/public/js/qhse/request_epp_v1.js"></script>
<?= $this->endSection() ?>