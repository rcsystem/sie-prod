...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-9">
          <h5 class="m-0">Voluntariado Inscripcion Permanente</h5>
        </div><!-- /.col -->
        <div class="col-sm-3">
        ...
        <div class="col-md-12">
          <div class="card-body mt-3">
            ...
            <div id="content-form" class="container-fluid mb-4">
              ...
              <input type="hidden" id="tipo_evento" name="tipo_evento" value="Voluntariado">
                <div class="form-row">
                ...
                <div id="extra_1" class="form-row ">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="tel" id="tel_contacto" name="tel_contacto" class="form-control" value="" />
                ...
                <div class="col-md-10 pt-4">
                  <h4>ASOCIACION EN LA QUE TE INTERESA PARTICIPAR</h4>
...
<script src="<?= base_url() ?>/public/js/qhse/hse_eventos_permanente_v2.js"></script>
