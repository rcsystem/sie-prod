    ...
    <div class="container-fluid">
      ...
      <div class="card card-default ">
        ...
        <div class="card-body">
          ...
          <table id="tbl_solicitudes_pagadas" class=" font-tables display compact dataTable table-bordered table-striped nowrap" style="width:100%">
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_solicitudes_pagadas_v1.js"></script>
