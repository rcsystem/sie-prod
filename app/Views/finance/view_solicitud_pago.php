                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="concepto" id="concepto" class="form-control">
                      ...
                      <option value="PAGO DE ARBITRAJES">PAGO DE ARBITRAJES</option>
                      <option value="PAGO NOMINA ESQUEMA">PAGO NOMINA ESQUEMA</option>
                      <option value="PAGO BECAS">PAGO BECAS</option>
                      <option value="PAGO UNIFORMES FUTBOL">PAGO UNIFORMES FUTBOL</option>
                      <option value="AYUDA DECEMBRINA">AYUDA DECEMBRINA</option>
                      <option value="REPARTO DE UTILIDADES BAJAS">REPARTO DE UTILIDADES BAJAS</option>
                      <option value="PAYNEFITS">PAYNEFITS</option>
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_solicitud_v18.js"></script>
<script>
