  ...
  <section class="content">
    <div class="container-fluid">
     ...
     <!--    <div class="col-md-12 text-right">
          ...
          <table id="tbl_pagar_solicitudes" class=" font-tables display compact dataTable table-bordered table-striped nowrap" style="width:100%">
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_pago_v3.js"></script>
