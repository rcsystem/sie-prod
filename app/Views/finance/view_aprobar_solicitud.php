...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 font-solicitud">Aprobar solicitud de pago</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default ">
        ...
        <div class="card-body">
          ...
          <table id="tbl_aprobar_adm" class=" font-tables display compact dataTable table-bordered table-striped nowrap" style="width:100%">
        ...
        <div id="pdfModalBody" class="modal-body">
          ...
          <div id="btnAcciones" class="col-md-12 row">
            ...
            <div class="col-md-4">
              ...
              <!-- Mensaje final que se muestra después de la solicitud -->
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_aprobar_v3.js"></script>
