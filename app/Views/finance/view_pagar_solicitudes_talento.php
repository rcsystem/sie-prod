...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 font-solicitud">Pagar Solicitudes</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
     ...
     <!--    <div class="col-md-12 text-right">
          ...
          <table id="tbl_pagar_solicitudes_talento" class=" font-tables display compact dataTable table-bordered table-striped nowrap" style="width:100%">
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_pago_talento_v1.js"></script>
