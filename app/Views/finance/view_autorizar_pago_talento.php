...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 font-solicitud">Autorizar Pagos</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default ">
        ...
        <div class="card-body">
          ...
          <table id="tbl_autorizar_pagos" class=" font-tables display compact dataTable table-bordered table-striped nowrap" style="width:100%">
...
<script src="<?= base_url() ?>/public/js/finance/finanzas_autorizar_pagos_v6.js"></script>
