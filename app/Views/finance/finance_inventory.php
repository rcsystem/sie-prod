...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default ">
        <div class="card-header">
          <h3 class="card-title">Inventario - Maquinaria</h3>
        ...
        <div class="card-body">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Maquinaria Activa</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Maquinaria Inactiva</button>
            </li>
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
              <div class="col-md-12">
                ...
                <div class="text-right">
                  <a class="btn btn-circle" onclick="abrirActivoModal()">
                    Nuevo Activo
                  </a>
              ...
              <div class="table-responsive" style="">
                ...
                <table id="tbl_finanzas_inventario" class="display compact dataTable table-bordered table-striped  nowrap" style="width:100%" role="grid" aria-describedby="finanzas_inventario">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <br>
              <div style="">
                <table id="tbl_inventario_inactivo" class="table table-striped table-bordered nowrap" style="width:100%" role="grid" aria-describedby="inventario_inactivo">
                </table>
              </div>
            </div>
  ...
  <section>
    <!-- Modal -->
    <div class="modal fade" id="activoModal" tabindex="-1" role="dialog" aria-labelledby="activoModal" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          ...
          <form id="alta_activos" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
              ...
              <button id="btn_activo" type="submit" class="btn btn-guardar">Guardar activo</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <section>
    <!-- Modal para editar -->
    <div class="modal fade" id="editarActivoModal" tabindex="-1" aria-labelledby="editarActivoModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editarActivoModalLabel">Editar Activo</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form id="form_editar_activo" method="post">
            <div class="modal-body">
