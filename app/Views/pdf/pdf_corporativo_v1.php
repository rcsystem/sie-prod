    ...
    <div class="container">
       ...
       <table class="table_uno">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                for ($i = 1; $i <= 12; $i++) { ?>
                                    <td class='' style='vertical-align: middle;'>
                                        <table class="table_dos" style="font-size: 8.5px;text-align:center;width:100%;">
                                            <tr>
                                ...
                                <?php } ?>
                                <td style="font-size: 8.5px;vertical-align: middle;width:auto;padding:1.2px;padding-bottom:0px;border: 0.3px solid #dddddd;color:#000;">---</td>
                                <td style="font-size: 8.5px;vertical-align: middle;width:auto;padding:1.2px;padding-bottom:0px;border: 0.3px solid #dddddd;color:#000;">---</td>
                                <td style="font-size: 8.5px;vertical-align: middle;width:auto;padding:1.2px;padding-bottom:0px;border: 0.3px solid #dddddd;color:#000;">---</td>
                                <td style="font-size: 8.5px;vertical-align: middle;width:auto;padding:1.2px;padding-bottom:0px;border: 0.3px solid #dddddd;color:#000;">---</td>
                            ...
                            ?>
                                <tr>
                                    ...
                                    for ($i = 1; $i <= 12; $i++) {
                                        ...
                                        if ($valor == '0') {
                                            echo " <td style='font-size: 8.5px;vertical-align: middle;'>{$valor}</td>";
                                        } else {
                                    ?>
                                            <td>
                                                ...
                                                <table class="table_dos" style="font-size: 8.5px;text-align:center;width:100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php echo '<td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">' . implode('</td><td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">', $valoresSeparados) . '</td>'; ?>
                                                    </tr>
                                                </table>
                                    ...
                                    if ($cont <= 6) {
                                        ...
                                        foreach ($dataCoffe["total_areas"] as $departamentos => $totalSolicitudes) {
                                            if ($departamento == $departamentos) {
                                                ...
                                                echo "<td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'>{$totalSolicitudes}</td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'>{$promedio}</td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'>{$valorPorcentaje} %</td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'>{$acumuladoTotal} %</td>";
                                            }
                                        }
                                    }
                                    ?>
                            ...
                            <tr>
                                <td style="text-align:center; font-size: 8.5px;">Grand Total </td>
                                ...
                                foreach ($dataCoffe["total_solicitudes"] as $departamento => $meses) {
                                    ...
                                    if ($valor == '0') { ?>
                                        <td style='background-color:#D9D9D9;text-align: center;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;'><?= $valor ?></td>
                                    <?php  } else { ?>
                                        ...
                                        <td style="background-color:#D9D9D9;">
                                            <table>
                                                <tr>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $meses; ?></td>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $dataCoffe["total_atendidas"][$departamento]; ?></td>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">
                                                        <?php
                                ...
                                ?>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'><?php echo $total_solicitudes; ?> </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'><?php echo $sumpromedio; ?> </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'><?php echo $totalPorcentaje . '%'; ?> </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'><?php echo $total2 . '%'; ?> </td>
                            </tr>
                    ...
                    <table class="table_uno">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    for ($i = 1; $i <= 12; $i++) {
                                        ...
                                        if ($valor == '0') { ?>
                                            <td style='font-size: 8.5px; vertical-align: middle;'><?= $valor ?></td>
                                        <?php  } else {
                                        ?>
                                            <td>
                                    ...
                                    ?>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $totalSolicitudes; ?></td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $promedio; ?></td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $valorPorcentaje . '%'; ?></td>
                                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $acumuladoTotal . '%'; ?></td>
                            ...
                            <tr>
                                ...
                                $total2 = ($total_solicitudes / $total_solicitudes) * 100;
                                ?>
                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $total_solicitudes ?> </td>
                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $sumpromedio ?> </td>
                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $totalPorcentaje . '%' ?> </td>
                                <td style='font-size: 8.5px; vertical-align: middle; background-color:#D9D9D9;'><?= $total2 . '%' ?> </td>
                            </tr>
                    ...
                    <table class="table_uno">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                for ($i = 1; $i <= 12; $i++) { ?>
                                    <td class='' style='vertical-align: middle;'>
                                        <table class="table_dos" style="vertical-align: middle;font-size: 8.5px;width:100%;">
                                    ...
                                    for ($i = 1; $i <= 12; $i++) {
                                        ...
                                        ?>
                                            <td>
                                                ...
                                                <table class="table_dos" style="vertical-align: middle;font-size: 8.5px;text-align:center;width:100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php echo '<td style="margin:auto;text-align:center;border:none;vertical-align:middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">' . implode('</td><td style="margin:auto;text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">', $valoresSeparados) . '</td>'; ?>
                                                    </tr>
                                                </table>
                            ...
                            <tr>
                                    ...
                                    <?php  } else { ?>
                                        ...
                                        <td style="background-color:#D9D9D9;">
                                            <table>
                                                <tr>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $meses; ?></td>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $dataTickets["total_atendidas"][$departamento]; ?></td>
                                                    <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">
                                                        <?php
                                ...
                                echo "<td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'>{$total_solicitudes} </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'>{$sumpromedio} </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'>{$totalPorcentaje} %  </td>
                                <td style='font-size: 8.5px;vertical-align: middle; background-color:#D9D9D9;'>{$total2} %  </td>";
                                ?>
                                        ...
                                        <?php  } else { ?>
                                            ...
                                            <td style="background-color:#D9D9D9;">
                                                <table>
                                                    <tr>
                                                        <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $meses; ?></td>
                                                        <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;"><?= $dataTicketsSg["total_atendidas"][$departamento]; ?></td>
                                                        <td style="text-align: center;border:none;vertical-align: middle;width:auto;padding: 2.8px;padding-bottom:0px;color:#D9D9D9;padding-top: 1px;font-size: 8.5px;color: #000;">
                                                            <?php
    ...
    <div class="container">
        ...
        <table class="table_uno">
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-size: 8.5px;vertical-align: middle;">No. Accidents</td>
                    <?php
                    ...
                    foreach ($mesesData as $valorMes) {
                        echo "<td style='font-size: 8.5px;vertical-align: middle;'>$valorMes</td>";
                    }
                    ?>
                </tr>
