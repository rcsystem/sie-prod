                        ...
                        <span>
                            ...
                            switch ($id_user) {
                                case 903:
                                    ...
                                    $autorizador = 'Karen Rubio - Jefe de Gestión de Talento';
                                    break;
                                case 1292:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Luis Angel Dominguez - Jefe de HSE';
                                    break;
                               
                                case 44:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Gabriel Rojas - Gerente de Ventas';
                                    break;
                                /*  case 152:
                                        // ✅ Insertar firma solo si es la primera página
                                        $autorizador = FCPATH . 'images/firmas_users/152/152.png';
                                        break; */
                                case 346:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Gabriel Rojas - Gerente de Ventas';
                                ...
                                case 303:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Abraham Sernas - Gerente de Almacenes y Logistica';
                                    break;
                                case 294:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'David Prado - Encargado de Impuestos';
                                    break;
                                case 277:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Abraham Sernas - Gerente de Almacenes y Logistica';
                                ...
                                case 31:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Alan Landa - Gerente de TI';
                                    break;
                                case 1334:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Alan Landa - Gerente de TI';
                                ...
                                case 1152:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Diego Nava - Jefe de Ventas OM & CSA';
                                    break;
                                case 26:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Blanca Pedraza - jefe de Contabilidad e Impuestos';
                                    break;
                                case 863:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Monserrat Sanchez - Director de Control Interno';
                                    break;
                                case 1361:
                                    // ✅ Insertar firma solo si es la primera página
                                    $autorizador = 'Diego Nava - Jefe de Ventas OM & CSA';
