...
<page backtop='20mm' backbottom='0mm' backleft='3mm' backright='3mm' footer='page'>
    ...
    <table class="tab1">
        <tbody>
            ...
            <tr>
                ...
                <td style="width:30%;text-align:right;"><span>Estatus: </span><?php switch ($request->authorize) {
                                                                                    case '2':
                                                                                        echo "Autorizada";
                                                                                        break;
                                                                                    case '3':
    ...
    <table class="tab2" style="margin-bottom:5px;">
        <tbody>
            ...
            <tr>
                <td class="title_tab">Usuario:</td>
                <td class="" style="text-align: center;width:28%;"><?= mb_convert_case($value->user, MB_CASE_TITLE, "UTF-8"); ?></td>
                <td class="title_dia" style="">Puesto: </td>
                <td class="" style="text-align: center;width: 30%;"><?= mb_convert_case($value->job, MB_CASE_TITLE, "UTF-8"); ?></td>
            </tr>
