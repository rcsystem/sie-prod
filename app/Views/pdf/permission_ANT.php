...
<page backtop='20mm' backbottom='0mm' backleft='3mm' backright='3mm' footer='page'>
    ...
    <div class="title">
        <?php if ($request->tipo_permiso != null) { ?>
            <H3>PERMISO <?php echo $request->tipo_permiso; ?></H3>
        <?php } else { ?>
    ...
    <table class="tab3" style="width:max-content;margin-bottom:40px;">
        ...
        <tbody>
            <tr>
                <td class=""><?= ($request->observaciones != "") ? $request->observaciones : " "; ?></td>
            </tr>
        </tbody>
    </table>
</page>