    ...
    <?php } else { ?>
        <div style="margin-left:8%;">
            <table class="tab2" style="margin-bottom:25px;">
                <tbody>
                    <tr>
                        <td class="title_tab" style="width: 18%;">Disfrutara:</td>
                        <td class="" style="font-size:16px;text-align:center;width:11%;"><?= ($request->num_dias_a_disfrutar != 0) ? $request->num_dias_a_disfrutar : "---"; ?></td>
                        <td class="title_tab" style="width: 18%;">Regresando:</td>
                        <td class="" style="text-align:center;font-size:16px;width:15%;"><?= ($request->regreso != "0000-00-00") ? date("d/m/Y", strtotime($request->regreso)) : "---"; ?></td>
                        <td class="title_tab" style="width: 18%;">Restan:</td>
                        <td class="" style="font-size:16px;text-align:center;width:11%;"><?= $request->dias_restantes; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div style="margin-left:28%;">
            <table class="tab2" style="text-align: center;">
                <thead>
                    <tr>
                        <th class="title_tab2" style="font-size: 18px !important;"> DIAS SOLICITADOS</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($days as $key) { ?>
                        <tr>
                            <td class="" style="font-size:16px;text-align:center;width:16%;"><?= $key->date_vacation; ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
