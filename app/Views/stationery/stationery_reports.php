     ...
     <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form id="formEntradas" method="post">

                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label for="entradas">Categoria</label>
                                <select name="categorias" id="categorias" class="form-control rounded-0" />
                                    <option value="">Seleccionar</option>
                                    <option value="1">ENTRADAS</option>
                                    <option value="2">SALIDAS</option>
                                </select>
                                <div id="error_categorias" name="error_categorias" class="text-danger"></div>
                            </div>
                            
                            <div class="form-group col-md-3">
                                <label for="inicio_entradas">Fecha Inicio</label>
                                <input type="date" class="form-control rounded-0" id="inicio_entradas" name="inicio_entradas" value="" />
                                <div id="error_inicio_entradas" name="error_inicio_entradas" class="text-danger"></div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="final_entradas">Fecha Final</label>
                                <input type="date" class="form-control rounded-0" id="final_entradas" name="final_entradas" value="" />
                                <div id="error_final_entradas" name="error_final_entradas" class="text-danger"></div>
                            </div>

                        </div>
                        <hr>
                        <button id="reporte_entradas" type="submit" class="btn btn-guardar btn-lg">Generar</button>
                    </form>
                </div>
...
<script src="<?= base_url() ?>/public/js/stationery/reports_v2.js"></script>
