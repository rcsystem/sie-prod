          ...
          <div class="container-fluid">
            <form id="nuevo_articulo" method="post">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  <label for="imagen">Unidad de Medida</label>
                 <select name="unidad" id="unidad" class="form-control">
                    ...
                    <option value="CAJA 25 PZAS">CAJA 25 PZAS</option>
                    <option value="CAJA 50 PZAS">CAJA 50 PZAS</option>
                    <option value="CAJA 100 PZAS">CAJA 100 PZAS</option>
                 </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="salida_articulos" method="post">
                            ...
                            <input type="hidden" id="code_epicor1" name="code_epicor1" value="">
...
<script src="<?= base_url() ?>/public/js/stationery/inventario_v4.js"></script>
