...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Seguimiento de Incidencias | Condiciones Inseguras</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Registro de Condiciones Inseguras</h3>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <img id="modalImage" src="" alt="Imagen del Modal" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<?= $this->endSection() ?>
<?= $this->section('js') ?>
<script src="<?= base_url() ?>/public/js/toursHSE/view_follow_conditions_tbl_v1.js"></script>
<?= $this->endSection() ?>