...
<div class="content-wrapper">
  ...
  <section>
    ...
    <div class="modal fade" id="editarVacacionesModal" tabindex="-1" aria-labelledby="editarVacacionesModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form id="editar_vacaciones" method="post">
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="number" class="form-control" id="editar_folio_vcns" name="editar_folio_vcns" readonly>
                </div>
                <div class="form-group col-md-6">
                  <label for="editar_usuario_vcns">Usuario</label>
                  <input type="text" class="form-control" id="editar_usuario_vcns" name="editar_usuario_vcns" readonly>
                </div>
                <div class="form-group col-md-6">
                  <label for="editar_vacaciones_del">Vacaciones del:</label>
                  <input id="editar_vacaciones_del" name="editar_vacaciones_del" class="form-control" value=""/>
                </div>
                <div class="form-group col-md-6">
                  <label for="editar_vacaciones_al">Vacaciones al:</label>
                  <input id="editar_vacaciones_al" name="editar_vacaciones_al" class="form-control" value="" />
                </div>
                <div class="form-group col-md-6">
                  <label for="editar_regresando">Regresando:</label>
                  <input id="editar_regresando" name="editar_regresando" class="form-control" value=""/>
                </div>
              </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
            <button id="actualiza_vacaciones" class="btn btn-guardar">Actualizar</button>
          </div>
          </form>
        </div>
      </div>
