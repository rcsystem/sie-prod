          ...
          <div class="container-fluid">
            <form id="permisos" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-4" style="text-align: center;">
                  ...
                  <div class="btn-group1 btn-group-toggle" data-toggle="buttons">
                    ...
                    <label class="btn btn-outline-festive btn-opcion" id="btn_opcion_4" style="display: none;">
                      <input type="radio" onclick="tipoPermiso(4)">
                      <p id="p_opcion_4" style="margin-bottom: 0 !important;"></p>
                    </label>
                  </div>
              ...
              <div id="div_cards_all" style="display: none;">
                ...
                <hr>
                <?php if (session()->type_of_employee == 2 || session()->id_user == 1063) { ?>
...
<script src="<?= base_url() ?>/public/js/permissions/permissions_generate_v7-2.js"></script>
<?= $this->endSection() ?>