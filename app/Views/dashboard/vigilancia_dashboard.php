            ...
            <div class="container-fluid">
                ...
                <div class="card collapsed-card">
                    <div class="card-header border-transparent">
                        <h3 class="card-title">Estadia Prolongada Proveedores & Visitantes</h3>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="tabla_proveedores_estadias" class=" m-0 table table-striped table-bordered nowrap" role="grid" aria-describedby="vacaciones_info" style="width:100%">
...
<script src="<?= base_url() ?>/public/js/dashboard/vigilancia_dashboard_v5-1.js"></script>
<?= $this->endSection() ?>                                    