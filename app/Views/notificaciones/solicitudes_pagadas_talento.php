...
<body>
  <div class="container">
    ...
    <div class="details">
      ...
      <p><strong>💲 Monto:</strong> $<?= number_format($request[0]["cantidad"], 2); ?></p>
    </div>

    <div class="comment">
      <p><strong>📝 Comentario:</strong> <?= !empty($request[0]["comentario_pago"]) ? htmlspecialchars($request[0]["comentario_pago"]) : "Sin comentario."; ?></p>
    </div>
