...
<head>
  ...
  <title>Notificación de Autorización</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h2>Solicitud de Pago Pendiente de Autorización</h2>
    <p>Estimado(a),</p>
    ...
    <a href="https://sie.grupowalworth.com/finanzas/autorizar_solicitud"  style="display: inline-block;
      padding: 10px 20px;
      background-color:rgb(19, 192, 71);
      color: #ffffff;
      text-decoration: none;
      border-radius: 5px;
      margin-top: 15px;">Autorizar Solicitud</a>
