...
<?php
/* $color = ($permisos->amount_permissions > 3 && $notify["tipo_permiso"] == "PERSONAL") ? "color:white;background:#f7304f;" : "color:black;";
$tipo_permiso = ($permisos->amount_permissions > 3 && $notify["tipo_permiso"] == "PERSONAL") ? "PERSONAL | EMERGENCIA" : $notify["tipo_permiso"]; */
...
if ($notify["num_permiso_mes"] == 4 && $notify["tipo_permiso"] == "PERSONAL") {
  ...
  $tipo_permiso = $notify["tipo_permiso"];
