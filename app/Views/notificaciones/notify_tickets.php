...
<body>
    <?php
    $prioridad = ['Error', '---', 'BAJA', 'MEDIA', 'ALTA'];
    ?>
    ...
    <div style="border: solid 3px #3C3C48;border-radius: 15px;width: 50%;height: auto;margin-right: auto;margin-left: auto;padding: 10px;">
        <div style="display: -ms-flexbox;display: flex;-ms-flex-wrap: wrap;flex-wrap: wrap;margin-right: -7.5px;margin-left: -7.5px;margin-left: auto;margin-right: auto;">
            ...
            <div style="width: 65%;">
                <form action="<?= base_url() ?>/tickets/tablero">
                    <?php if ($tipo == 1) { ?>
                    ...
                    <?php } else if ($tipo == 3) {
                        ...
                        <p style="margin-left:5%;font-family: Century Gothic;">Su ticket con los siguientes datos paso a "<b><?= $opcion[$opc]; ?></b>"</p>
                    <?php } else if ($tipo == 4) { ?>
                    ...
                    <ul class="cuadrado" style="list-style-type: circle;font-family: Century Gothic;">
                        <?php if ($tipo == 1) { ?>
                            ...
                            <li style="padding: 2px;">Actividad: <b><?= $actividad->act; ?></b></li>
                            <li style="padding: 2px;">Clasificación: <b><?= $actividad->class; ?></b></li>
